...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="w-full min-h-screen lg:h-full flex items-center justify-center overflow-hidden z-20 p-0 lg:p-8">
        ...
        >
            ...
            <AnimatePresence>
              {mobileOpen && (
                ...
                >
                  ...
                  <a
                    href="tel:+94788056838"
                    className="flex items-center justify-center gap-2 text-slate-300 bg-sky-950/40 border border-sky-500/20 py-2.5 rounded-xl text-xs font-bold transition-all hover:text-white mt-2"
                  >
                    <PhoneCall className="w-3.5 h-3.5 text-sky-400" />
                    +94 78 805 6838
                  </a>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-4 items-center z-10 relative">
              ...
              <div className="flex flex-col items-start text-left lg:col-span-4 xl:col-span-4 max-w-md order-2 lg:order-1 mt-4 lg:mt-0">
                ...
                <p className="text-sm md:text-base text-slate-400/90 leading-relaxed mb-9 max-w-sm font-light">
                  We design and engineer bespoke digital solutions that turn
                  bold ideas into market-leading realities.
                </p>
              ...
              {/* Right Side: Navigation LineSidebar */}
          ...
          <footer className="relative w-full z-30 px-6 md:px-12 py-6 flex items-center justify-between border-t border-white/5 bg-[#050C18]">
            {/* Social Icons */}
            <div ref={footerIconsRef} className="flex items-center gap-3.5">
              <a
