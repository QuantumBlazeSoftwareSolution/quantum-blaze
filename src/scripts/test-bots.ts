...
async function sendMainBotTest() {
  ...
  try {
    ...
    console.log("Main Bot Response:", data.ok ? "SUCCESS ✅" : "FAILED ❌", data.description || "");
  } catch (error) {
...
async function runTest() {
  ...
  console.log("\n--- Testing Monitor Bot ---");
  await sendMonitorAlert("ANALYTICS", "Monitor Bot Connectivity Test Successful! 📊✨");
  console.log("Monitor Bot test triggered (check console for logs if any issues).");
